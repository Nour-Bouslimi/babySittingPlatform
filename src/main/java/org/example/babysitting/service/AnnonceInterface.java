...
public interface AnnonceInterface {
    ...
    List<Annonce> getAnnoncesByUser_idUser(Long idUser); //ajout de la méthode pour récupérer les annonces par l'ID de l'utilisateur
    List<Annonce> getAnnoncesByDate(LocalDate date); //ajout de la méthode pour récupérer les annonces par date
